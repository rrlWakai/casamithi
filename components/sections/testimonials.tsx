...
const testimonials = [
  {
    quote: "Casa Mithi redefined what luxury means to us. The attention to detail, the serene atmosphere — it was an escape in every sense.",
    author: "Alexandra M.",
    location: "London, UK",
  },
  {
    quote: "We celebrated our anniversary here and it exceeded every expectation. The privacy, the beauty, the impeccable service.",
    author: "James & Sarah T.",
    location: "New York, USA",
  },
  {
    quote: "A hidden gem that feels like your own private paradise. We have found our new sanctuary.",
    author: "Marie L.",
