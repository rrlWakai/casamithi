    ...
    <>
      ...
      >
        <nav className="flex items-center justify-between max-w-[1600px] mx-auto">
          ...
          {/* Desktop Navigation */}
          <div className={`hidden md:flex items-center gap-8 lg:gap-12 text-xs tracking-wider uppercase font-sans transition-colors duration-300 ${
            ...
            <a href="#about" className="relative group">
              <span className="hover:opacity-80 transition-opacity">Experience</span>
              <span className="absolute -bottom-1 left-0 w-0 h-px bg-current group-hover:w-full transition-all duration-300" />
            </a>
            <a href="#gallery" className="relative group">
              <span className="hover:opacity-80 transition-opacity">Gallery</span>
              <span className="absolute -bottom-1 left-0 w-0 h-px bg-current group-hover:w-full transition-all duration-300" />
            </a>
            <a href="#stories" className="relative group">
              <span className="hover:opacity-80 transition-opacity">Stories</span>
              <span className="absolute -bottom-1 left-0 w-0 h-px bg-current group-hover:w-full transition-all duration-300" />
            </a>
            <a href="#booking" className={`px-6 py-3 transition-all ${
              isScrolled 
          ...
          >
            <span className={`block w-full h-px bg-current transform transition-transform ${
              isMobileMenuOpen ? "rotate-45 translate-y-2.5" : ""
            }`} />
            <span className={`block w-full h-px bg-current transition-opacity ${
