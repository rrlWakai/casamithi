...
export function Gallery() {
  return (
    <section id="gallery" className="py-24 md:py-32 lg:py-48 px-4 md:px-8 lg:px-16 overflow-hidden">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="hidden lg:grid grid-cols-4 gap-4">
          ...
          <div className="col-span-4 my-8 flex items-center gap-8">
            ...
            <span className="text-primary/40 text-xs tracking-[0.3em] uppercase font-sans">Experiences</span>
            <div className="flex-1 h-px bg-primary/20" />
          </div>
