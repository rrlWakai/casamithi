...
const LOGO_URL = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/logoos-qWlhceyY4ausN9V3QBgAZCKedNFCkc.jpg";
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            >
              A private villa resort where luxury meets serenity. Your sanctuary in paradise awaits.
            </motion.p>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-primary-foreground/70 font-sans text-sm">
              <li>
                <a href="tel:09176564844" className="hover:text-primary-foreground transition-colors">
                  0917 65 MITHI (64844)
                </a>
              </li>
              <li>
                <a href="mailto:reservations@casamithi.com" className="hover:text-primary-foreground transition-colors">
                  reservations@casamithi.com
                </a>
              </li>
              <li className="pt-2">
                <span className="text-primary-foreground/60">
                  Google Maps or Waze Pin:<br />
            ...
            <ul className="flex flex-col gap-3 text-primary-foreground/70 font-sans text-sm">
              <li>
                <a href="#" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Home</span>
              ...
              <li>
                <a href="#about" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Experience</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
              <li>
                <a href="#gallery" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Gallery</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
              <li>
                <a href="#stories" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Stories</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
              <li>
                <a href="#booking" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Reservations</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-primary-foreground/70 font-sans text-sm">
              <li>
                <a href="#" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Instagram</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
              <li>
                <a href="#" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">Facebook</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
              <li>
                <a href="#" className="relative group inline-block">
                  <span className="hover:text-primary-foreground transition-colors">TikTok</span>
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground group-hover:w-full transition-all duration-300" />
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/50 text-xs tracking-wider font-sans">
            &copy; {new Date().getFullYear()} Casa Mithi Private Villas Resort. All rights reserved.
          </p>
          <div className="flex items-center gap-6 text-primary-foreground/50 text-xs tracking-wider font-sans">
            <a href="#" className="relative group inline-block">
              <span className="hover:text-primary-foreground/80 transition-colors">Privacy Policy</span>
            ...
            <a href="#" className="relative group inline-block">
              <span className="hover:text-primary-foreground/80 transition-colors">Terms of Service</span>
              <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-primary-foreground/50 group-hover:w-full transition-all duration-300" />
            </a>
          </div>
        </div>
