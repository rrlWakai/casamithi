...
export function About() {
  ...
  return (
    <section ref={ref} className="relative py-32 md:py-48 lg:py-64 px-6 md:px-12 lg:px-24 overflow-hidden">
      <div className="max-w-[1600px] mx-auto">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <p>
                Casa Mithi is more than a destination — it is an invitation to slow down, 
                to breathe deeply, and to rediscover the beauty of unhurried moments.
              </p>
              <p>
                Nestled within private grounds, our villa offers absolute seclusion 
                without compromising on the refined comforts you deserve. Every detail 
                has been curated to create an atmosphere of understated elegance.
              </p>
            </motion.div>
            ...
            >
              ...
              <span className="text-primary text-xs tracking-[0.2em] uppercase font-sans">Est. 2024</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
