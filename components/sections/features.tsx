...
const features = [
  {
    ...
    description: "Immerse yourself in crystal-clear waters while gazing upon endless horizons. Your personal oasis awaits.",
    image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=1200&q=80",
    alignment: "left" as const,
  },
  {
    title: "Luxury Suites",
    description: "Wake to gentle breezes and soft light in our thoughtfully designed bedrooms, where comfort meets sophistication.",
    image: "https://images.unsplash.com/photo-1582719508461-905c673771fd?w=1200&q=80",
    alignment: "right" as const,
  },
  {
    title: "Event-Ready Spaces",
    description: "From intimate gatherings to grand celebrations, our versatile venues provide the perfect backdrop for unforgettable moments.",
    image: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=1200&q=80",
    alignment: "left" as const,
  },
  {
    title: "Serene Atmosphere",
    description: "Let the gentle rustle of palms and the distant song of birds compose the soundtrack to your escape.",
