...
const HERO_IMAGE_URL = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/hero11-bD6RZCUGZCNgyRKsyGjvhBO1QU7My3.jpg";
    ...
    <section ref={ref} className="relative h-screen w-full overflow-hidden">
      ...
      >
        <div className="max-w-4xl">
          ...
          >
            Discover Casa Mithi — a private villa resort where luxury, comfort, and peaceful surroundings come together for an unforgettable stay.
          </motion.p>
